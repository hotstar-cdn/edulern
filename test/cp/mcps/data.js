      ...
      },
{
        ...
        correct_answer: "B",
        solution_text: "The generative cell in the pollen tube divide to produce two male nuclei.",
        solution_image: null,
      },
{
        id: "c1q5",
        ...
        question_image: null, // No main image for this question
        options: [
          { id: "A", text: 1 Robert Hook, image: "null" },
          { id: "B", text: 2 Alex Paul, image: "null" },
          { id: "C", text: 3 George John Mendal, image: "null" },
          { id: "D", text: 4 Ricky Brown, image: "null" },
        ],
        correct_answer: "A",
        solution_text: "Robert Hooke discovered the dead cell for the very first time in the bark of tree. The discovery of living cell is credited to Anton Van Leeuwenhoek.",
        solution_image: null,
      },
{
        id: "c1q6",
        ...
        question_image: null, // No main image for this question
        options: [
          { id: "A", text: 1 Pollination, image: "null" },
          { id: "B", text: Fertilization, image: "null" },
          { id: "C", text: Binary Fussion, image: "null" },
          { id: "D", text: 4 Non of Above, image: "null" },
        ],
        correct_answer: "B",
...
(v) Chloroplast is a plastid which contain green colour pigment called chlorophyll.",
        ...
        correct_answer: "A",
        solution_text: "In 1831, Robert Brown discovered the nucleus. Viruses are neither a prokaryote nor eukaryote.",
        solution_image: null,
      },
{
        id: "c1q9",
        ...
        correct_answer: "C",
        solution_text: "Cotyledons are structure which stores food for the developing embryo. Embryo then utilize the food to divide further and give rise to radicle (root) and plumule (stem)",
        solution_image: null,
      },
{
        id: "c1q10",
        ...
        correct_answer: "D",
        solution_text: "Prostate gland secretes - Waterley fluid. 
Seminal vesicle secrets - Fructose by which sperm gain energy for mobility.
Cowper gland - neutralize the acidic nature in urethera due to urine. All these gland secretions + Sperm = Seminal Fluid.  ",
        solution_image: null,
      },
{
        id: "c1q11",
        ...
        question_image: null, // No main image for this question
        options: [
          { id: "A", text: metabolicolly inactive, image: "null" },
          { id: "B", text: dormant, image: "null" },
          { id: "C", text: resting stage, image: "null" },
          { id: "D", text: All of the Above, image: "null" },
        ],
        correct_answer: "D",
        solution_text: "Seeds are metabolically in active, that is they are  dormant and remains in resting stage",
        solution_image: null,
      },
{
        id: "c1q12",
      ...
      },
{
        ...
        options: [
          ...
          { id: "B", text: implacentation, image: "null" },
      ...
      },
{
        ...
        question_image: null, // No main image for this question
        options: [
          { id: "A", text: Embryo Sec, image: "null" },
          { id: "B", text: Style, image: "null" },
          { id: "C", text: stigma, image: "null" },
          { id: "D", text: Both A and C, image: "null" },
        ],
        correct_answer: "A",
        solution_text: "Embryosac is the structure inside the ovule which contain female gamete i.e., egg cell. So, fertilization takes place in Embryosac.",
        solution_image: null,
      },
